...
| `metadata.json` | gpx-manifest.sh | Per-route overrides keyed by `Region/Trail name`. Currently surfaces a `source` URL into the trail popup. Optional; missing entries fall back to defaults. |
